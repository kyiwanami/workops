...
class RequestMapperIntegrationTests extends MapperIntegrationTestBase {
  ...
  void requestMapperCreatesFindsAndSubmitsRequestInsideCompanyBoundary() {
    ...
    requestMapper.insertDraft(1L, 2L, assetId, 10L, "M8申請", "M8申請内容", 2L, 2L);
    ...
    int otherCompanyUpdated =
        requestMapper.submitDraftByIdAndCompanyId(requestId, 2L, 2L, LocalDateTime.now(), 2L);
    int updated =
        requestMapper.submitDraftByIdAndCompanyId(requestId, 1L, 2L, LocalDateTime.now(), 2L);
  ...
  void requestMapperShowsParentRequestWhenLinkedAssetIsDeletedAndExcludesItFromOptions() {
    ...
    requestMapper.insertDraft(1L, 2L, assetId, 10L, "削除済み資産参照申請", "削除済み資産参照申請内容", 2L, 2L);
    Long requestId = requestMapper.findLastInsertId();
  ...
  void requestMapperShowsParentRequestWhenRequestTypeIsDeletedAndExcludesItFromOptions() {
    requestMapper.insertDraft(1L, 2L, null, 11L, "削除済み申請種別参照申請", "削除済み申請種別参照申請内容", 2L, 2L);
    Long requestId = requestMapper.findLastInsertId();
