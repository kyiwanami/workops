...
public class DepartmentAdminController {
  ...
  public String platformList(
    ...
    DepartmentListPage departmentListPage =
        departmentAdminService.findPlatformDepartmentList(companyId, departmentSearchForm);
  ...
  public String platformNewForm(@PathVariable Long companyId, Model model) {
    DepartmentListPage departmentListPage =
        departmentAdminService.findPlatformDepartmentFormPage(companyId);
  ...
  public String platformEditForm(
      @PathVariable Long companyId, @PathVariable Long departmentId, Model model) {
    DepartmentListPage departmentListPage =
        departmentAdminService.findPlatformDepartmentFormPage(companyId);
  ...
  private void prepareListModel(
      Model model, DepartmentListPage departmentListPage, boolean platformAdmin) {
