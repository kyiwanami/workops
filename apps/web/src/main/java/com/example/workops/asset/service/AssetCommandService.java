...
public class AssetCommandService {
    ...
    public Long createAsset(AssetForm assetForm) {
        LoginUserContext currentUser = currentUserProvider.requireCurrentUser();
        assertSelectableAssetCategory(assetForm.assetCategoryValueId(), currentUser, OPERATION_ASSET_CREATE, null);
    ...
    public void updateAsset(Long id, AssetForm assetForm) {
        ...
        assertSelectableAssetCategory(assetForm.assetCategoryValueId(), currentUser, OPERATION_ASSET_UPDATE, id);
    ...
    public void updateStatus(Long id, AssetStatusForm assetStatusForm) {
        ...
        assertSelectableStatus(assetStatusForm.statusCode(), currentUser, OPERATION_ASSET_STATUS_CHANGE, id);
    ...
    private AssetDetail findAssetForOperation(Long id, LoginUserContext currentUser, String operation) {
        return assetMapper.findDetailByIdAndCompanyId(id, currentUser.companyId())
                .orElseThrow(() -> {
    ...
    private void assertSelectableAssetCategory(
            ...
            String operation,
            Long targetId) {
        if (!assetMapper.existsAssetCategoryByIdAndCompanyId(assetCategoryValueId, currentUser.companyId())) {
    ...
    private void assertSelectableDepartment(
            ...
            String operation,
            Long targetId) {
        if (departmentId != null && !assetMapper.existsDepartmentByIdAndCompanyId(departmentId, currentUser.companyId())) {
    ...
    private void assertUniqueCodeForCreate(String code, LoginUserContext currentUser, String operation) {
    ...
    private void assertUniqueCodeForUpdate(Long id, String code, LoginUserContext currentUser, String operation) {
