 ...
 *
 * <p>入力値や例外メッセージはログ本文へ出さず、requestId、status、path、例外種別だけを
 * CloudWatch Logsで検索できる形式にする。</p>
 */
@Component
public class ApplicationExceptionLogger {

    private static final Logger APPLICATION_LOGGER = LoggerFactory.getLogger("com.example.workops.application");
