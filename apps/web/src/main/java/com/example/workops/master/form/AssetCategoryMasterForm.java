...
public record AssetCategoryMasterForm(
        @NotBlank(message = "資産分類コードを入力してください。")
        @Size(max = 50, message = "資産分類コードは50文字以内で入力してください。")
        String code,
        @NotBlank(message = "資産分類名を入力してください。")
        @Size(max = 100, message = "資産分類名は100文字以内で入力してください。")
        String name,
