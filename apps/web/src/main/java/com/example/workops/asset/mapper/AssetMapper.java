...
public interface AssetMapper {
  ...
  boolean existsAssetCategoryByIdAndCompanyId(
      @Param("assetCategoryValueId") Long assetCategoryValueId, @Param("companyId") Long companyId);
  ...
  boolean existsOtherAssetCodeByCompanyId(
      @Param("id") Long id, @Param("code") String code, @Param("companyId") Long companyId);
  ...
  int logicalDeleteAssetByIdAndCompanyId(
      @Param("id") Long id, @Param("companyId") Long companyId, @Param("updatedBy") Long updatedBy);
}
