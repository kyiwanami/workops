...
public class UserAdminController {
  ...
  private void preparePlatformFormModel(Model model) {
    ...
    model.addAttribute(
        "platformPermissionSets", userAdminService.findPlatformPermissionSetOptions());
  ...
  private void prepareDetailModel(Model model, UserDetail user, boolean platformAdmin) {
    ...
    model.addAttribute(
        "editHref",
        platformAdmin ? "/admin/users/" + user.id() + "/edit" : "/users/" + user.id() + "/edit");
  }
  ...
  private void preparePlatformEditModel(Model model, UserEditTarget user) {
    ...
    model.addAttribute(
        "departments", userAdminService.findActiveDepartmentsByCompanyId(user.companyId()));
