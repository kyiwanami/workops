...
public class RequestTypeMasterController {
    ...
    public String list(
            @ModelAttribute("requestTypeMasterSearchForm") RequestTypeMasterSearchForm requestTypeMasterSearchForm,
            Model model) {
        model.addAttribute("requestTypes", requestTypeMasterService.findList(requestTypeMasterSearchForm));
