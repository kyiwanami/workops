...
public interface UserAdminMapper {
  ...
  boolean existsTenantEmail(@Param("companyId") Long companyId, @Param("email") String email);

  boolean existsPlatformEmailExcludingUser(
      @Param("userId") Long userId, @Param("email") String email);
  ...
  int insertUserPermissionSetByCode(
      @Param("userId") Long userId, @Param("permissionSetCode") String permissionSetCode);
