...
public class SecurityConfig {
  ...
  public SecurityFilterChain cognitoSecurityFilterChain(
    ...
    http.authorizeHttpRequests(
        ...
        .oauth2Login(
            oauth2 ->
                oauth2
                    // CloudFront is the public host; route unauthenticated users to the
                    // tenant-facing login page.
                    .loginPage("/login")
  ...
  public SecurityFilterChain localSecurityFilterChain(
      HttpSecurity http, LocalAuthenticationFilter localAuthenticationFilter) throws Exception {
