...
public class AssetCategoryMasterController {
    ...
    public String list(
            @ModelAttribute("assetCategoryMasterSearchForm") AssetCategoryMasterSearchForm assetCategoryMasterSearchForm,
            Model model) {
        model.addAttribute("assetCategories", assetCategoryMasterService.findList(assetCategoryMasterSearchForm));
    ...
    public String create(
            @Valid @ModelAttribute("assetCategoryMasterForm") AssetCategoryMasterForm assetCategoryMasterForm,
