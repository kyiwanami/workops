...
public record RequestTypeMasterForm(
    @NotBlank(message = "申請種別コードを入力してください。") @Size(max = 50, message = "申請種別コードは50文字以内で入力してください。")
        String code,
    @NotBlank(message = "申請種別名を入力してください。") @Size(max = 100, message = "申請種別名は100文字以内で入力してください。")
        String name,
